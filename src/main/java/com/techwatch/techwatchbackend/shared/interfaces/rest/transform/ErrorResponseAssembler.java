...
import com.techwatch.techwatchbackend.shared.interfaces.rest.resources.ErrorResource;
...
public final class ErrorResponseAssembler {
     ...
     *
     * @param errorCode the error code string (e.g., "PROPERTY_NOT_FOUND", "VALIDATION_ERROR")
